...
public class RoomDAODB implements RoomDao {
    ...
    public Room getRoomById(int id) {
       ...
       try { final String SELECT_ROOM_BY_ID = "SELECT * FROM room WHERE id = ?  ";
    ...
    public void deleteRoomById(int id) {
       ...
       final String DELETE_MEEITNG_BY_ROOM = "DELETE FROM meeting where roomId = ? "; 
       jdbc.update(DELETE_MEEITNG_BY_ROOM , id);
